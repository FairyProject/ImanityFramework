package org.imanity.framework.menu;
...
public abstract class Menu {
	...
	@Getter
	private Map<Integer, org.imanity.framework.menu.Button> buttons = new HashMap<>();
	...
	private org.imanity.framework.menu.Button placeholderButton = org.imanity.framework.menu.Button.placeholder(Material.STAINED_GLASS_PANE, (byte) 15, " ");

	private ItemStack createItemStack(final Player player, final org.imanity.framework.menu.Button button) {
	...
	public void openMenu(final Player player, boolean update) {
		...
		final org.imanity.framework.menu.Menu previousMenu = org.imanity.framework.menu.Menu.currentlyOpenedMenus.get(player.getUniqueId());
		...
		for (final Map.Entry<Integer, org.imanity.framework.menu.Button> buttonEntry : this.buttons.entrySet()) {
	...
	public int size(final Map<Integer, org.imanity.framework.menu.Button> buttons) {
		int highest = 0;
	...
	public abstract Map<Integer, org.imanity.framework.menu.Button> getButtons(Player player);
