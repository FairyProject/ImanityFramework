...
public class Find {
    ...
    Find(DBCollection collection, ReadPreference readPreference, Deserializer deserializer, QueryFactory queryFactory, String query, Object... parameters) {
    ...
    Find(DBCollection collection, ReadPreference readPreference, Deserializer deserializer, QueryFactory queryFactory, ObjectIdUpdater idUpdater, Object example) {
        this.readPreference = readPreference;
        this.deserializer = deserializer;
        this.collection = collection;
        this.queryFactory = queryFactory;
        this.query = this.queryFactory.createQuery(idUpdater, example);
        this.modifiers = new ArrayList<>();
    }
    // Imanity end
