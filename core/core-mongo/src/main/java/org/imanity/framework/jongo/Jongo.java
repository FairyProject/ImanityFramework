...
import org.imanity.framework.jongo.bson.BsonDBEncoder;
import org.imanity.framework.jongo.serializer.jackson.JacksonMapper;
import org.imanity.framework.jongo.bson.BsonDBDecoder;
import org.imanity.framework.jongo.query.Query;

/**
 * This is a modified version of Jongo
 * Original: http://jongo.org/
 *
 * @author bguerout
 * @modified LeeGod
 */
public class Jongo {
    ...
    public Jongo(DB database) {
        this(database, JacksonMapper.Builder.jacksonMapper().build());
    }
    ...
    public Command runCommand(String query, Object... parameters) {
        return new Command(database, mapper.getDeserializer(), mapper.getQueryFactory(), query, parameters);
    }
}
