...
import org.imanity.framework.jongo.query.Query;
...
public class MongoCollection {
    ...
    public FindOne findOne(ObjectId id) {
        ...
        return new FindOne(collection, readPreference, mapper.getDeserializer(), mapper.getQueryFactory(), "{_id:#}", id);
    }
    ...
    public FindOne findOne(String query, Object... parameters) {
        return new FindOne(collection, readPreference, mapper.getDeserializer(), mapper.getQueryFactory(), query, parameters);
    }

    // Imanity - start
    public FindOne findOne(Object example) {
        return new FindOne(collection, readPreference, mapper.getDeserializer(), mapper.getQueryFactory(), this.mapper.getObjectIdUpdater(), example);
    }
    // Imanity end
    ...
    public Find find(String query, Object... parameters) {
        return new Find(collection, readPreference, mapper.getDeserializer(), mapper.getQueryFactory(), query, parameters);
    }

    public Find find(Object example) {
        return new Find(collection, readPreference, mapper.getDeserializer(), mapper.getQueryFactory(), this.mapper.getObjectIdUpdater(), example);
    }
    ...
    public FindAndModify findAndModify(String query, Object... parameters) {
        return new FindAndModify(collection, mapper.getDeserializer(), mapper.getQueryFactory(), query, parameters);
    }
    ...
    public WriteResult save(Object pojo) {
        return new Insert(collection, writeConcern, mapper.getSerializer(), mapper.getObjectIdUpdater(), mapper.getQueryFactory()).save(pojo);
    }
    ...
    public WriteResult insert(Object... pojos) {
        return new Insert(collection, writeConcern, mapper.getSerializer(), mapper.getObjectIdUpdater(), mapper.getQueryFactory()).insert(pojos);
    }

    public WriteResult insert(String query, Object... parameters) {
        return new Insert(collection, writeConcern, mapper.getSerializer(), mapper.getObjectIdUpdater(), mapper.getQueryFactory()).insert(query, parameters);
    }
    ...
    public WriteResult remove(Object example) {
        return collection.remove(createQuery(example).toDBObject(), writeConcern);
    }

    public Distinct distinct(String key) {
        return new Distinct(collection, mapper.getDeserializer(), mapper.getQueryFactory(), key);
    }
    ...
    public Aggregate aggregate(String pipelineOperator, Object... parameters) {
        return new Aggregate(collection, mapper.getDeserializer(), mapper.getQueryFactory()).and(pipelineOperator, parameters);
    }
    ...
    private Query createQuery(Object example) {
        return mapper.getQueryFactory().createQuery(this.mapper.getObjectIdUpdater(), example);
    }
