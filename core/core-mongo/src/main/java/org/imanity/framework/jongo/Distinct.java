...
public class Distinct {
    ...
    Distinct(DBCollection dbCollection, Deserializer deserializer, QueryFactory queryFactory, String key) {
    ...
    public <T> List<T> as(final Class<T> clazz) {
        ...
        if (distinct.isEmpty() || resultsAreBSONPrimitive(distinct))
            ...
            return typedList((List<DBObject>) distinct, newResultHandler(clazz, deserializer));
        }
    }
