...
import org.imanity.framework.jongo.ReflectiveObjectIdUpdater;
...
public class JacksonIdFieldSelector implements ReflectiveObjectIdUpdater.IdFieldSelector {
    ...
    public boolean isObjectId(Field f) {
        return f.isAnnotationPresent(org.imanity.framework.jongo.serializer.jackson.oid.ObjectId.class)
