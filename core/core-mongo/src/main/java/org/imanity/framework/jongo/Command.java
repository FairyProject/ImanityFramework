...
public class Command {
    ...
    public Command(DB db, Deserializer deserializer, QueryFactory queryFactory, String query, Object... parameters) {
        this.db = db;
    ...
    public <T> T as(final Class<T> clazz) {
        return map(ResultHandlerFactory.newResultHandler(clazz, deserializer));
    }
