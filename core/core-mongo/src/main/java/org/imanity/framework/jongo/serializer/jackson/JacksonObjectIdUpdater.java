...
import org.imanity.framework.jongo.serializer.jackson.oid.Id;
import org.imanity.framework.jongo.serializer.jackson.oid.MongoId;
import org.imanity.framework.jongo.serializer.jackson.oid.MongoObjectId;
...
public class JacksonObjectIdUpdater implements ObjectIdUpdater {
    ...
    public static class BeanPropertyDefinitionIdSelector implements IdSelector<BeanPropertyDefinition> {
        ...
        public boolean isObjectId(BeanPropertyDefinition property) {
            return property.getPrimaryMember().getAnnotation(org.imanity.framework.jongo.serializer.jackson.oid.ObjectId.class) != null
