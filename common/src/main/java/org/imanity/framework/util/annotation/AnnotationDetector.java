...
public final class AnnotationDetector {
    ...
    public void detect() throws IOException {
        detect(new org.imanity.framework.util.annotation.ClassFileIterator());
    }
    ...
    public void detect(final String... packageNames) throws IOException {
        ...
        if (!files.isEmpty()) {
            ...
            detect(new org.imanity.framework.util.annotation.ClassFileIterator(files.toArray(new File[0]), pkgNameFilter));
        }
    }
    ...
    public void detect(final File... filesOrDirectories) throws IOException {
        ...
        detect(new org.imanity.framework.util.annotation.ClassFileIterator(filesOrDirectories, null));
    }
